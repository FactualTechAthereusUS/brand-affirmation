    ...
    <div className="pt-5">
      ...
      <div className="mt-5 space-y-2.5 px-4">
        ...
        <Card>
          ...
          <button className="mt-4 flex w-full items-center gap-3 rounded-full bg-white p-1.5 pr-2 shadow-[0_2px_14px_rgba(0,0,0,0.06)] transition active:scale-[.97]">
            <div className="relative h-12 w-12 shrink-0 overflow-hidden rounded-full bg-[#E8E4DC]">
              <img src={vialSemaglutide.url} alt="Semaglutide vial" className="h-full w-full object-contain p-1" />
            </div>
            <span className="flex-1 text-left text-[15px] font-semibold text-ink">Track order</span>
