...
export const Route = createFileRoute("/pharmabro-admin/leads/$id")({
  head: () => ({ meta: [
    ...
    return (
      <AdminShell title="Lead">
        <Card className="p-8 text-center">
          ...
          <Link to="/pharmabro-admin/leads" className="mt-2 inline-block text-[12.5px] font-semibold text-indigo-700 hover:underline">← Back to leads</Link>
        </Card>
      </AdminShell>
    );
  }
  ...
  return (
    <AdminShell title="Lead">
      <div className="mb-3 flex items-center justify-between">
        <button onClick={() => nav({ to: "/pharmabro-admin/leads" })} className="inline-flex items-center gap-1 text-[12.5px] font-semibold text-indigo-700 hover:underline">
        ...
        <div className="space-y-4">
          ...
          <Card className="p-5">
            ...
            <div className="space-y-2">
              ...
              <button onClick={() => { if (confirm("Delete this lead? This cannot be undone.")) { adminActions.deleteLead(lead.id); nav({ to: "/pharmabro-admin/leads" }); } }}
