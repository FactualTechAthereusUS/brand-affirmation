...
export const Route = createFileRoute("/pharmabro-admin/team")({
  head: () => ({
    meta: [
    ...
    <AdminShell title="Team">
      ...
      <Card className="p-5">
        <div className="mb-3 flex items-center justify-between">
          ...
          <Link to="/pharmabro-admin/settings/compliance" className="text-[11px] font-semibold text-marine hover:underline">
            View full audit log →
          </Link>
        </div>
        {teamAudit.length === 0 ? (
