...
export const Route = createFileRoute("/pharmabro-admin/orders/$id")({
  head: ({ params }) => ({ meta: [
...
function OrderDetailPage() {
  const { id } = useParams({ from: "/pharmabro-admin/orders/$id" });
    ...
    return (
      <AdminShell title="Order">
        <Card className="p-8 text-center">
          ...
          <Link to="/pharmabro-admin/orders" className="mt-3 inline-block text-[13px] font-semibold text-indigo-600 hover:underline">Back to orders</Link>
        </Card>
      </AdminShell>
    );
  }
    ...
    <AdminShell title="Order">
      ...
      <div className="mb-4 flex flex-wrap items-start justify-between gap-3">
        <div className="min-w-0">
          <button onClick={() => nav({ to: "/pharmabro-admin/orders" })} className="mb-2 inline-flex items-center gap-1 text-[12px] font-medium text-ink/55 hover:text-ink">
      ...
      <div className="grid gap-4 lg:grid-cols-[1fr_320px]">
        ...
        <div className="space-y-4">
          ...
          {/* Clinical excerpt */}
          <Card className="p-4">
            <SectionHead icon={<Stethoscope className="h-4 w-4 text-indigo-600" />} title="Clinical review" right={<Link to="/pharmabro-admin/physician-queue" className="inline-flex items-center gap-1 text-[11.5px] font-semibold text-indigo-600 hover:underline">Open case <ExternalLink className="h-3 w-3" /></Link>} />
        ...
        <div className="space-y-4">
          ...
          <Card className="p-4">
            ...
            <Link to="/pharmabro-admin/patients/$id" params={{ id: order!.patientId }} className="mt-3 inline-flex items-center gap-1 text-[11.5px] font-semibold text-indigo-600 hover:underline">View patient <ExternalLink className="h-3 w-3" /></Link>
          </Card>
  ...
  if (o.rxStatus === "pending_review") {
    return (
      <div className="mb-4 flex flex-wrap items-center justify-between gap-3 rounded-xl border border-amber-200 bg-amber-50 px-4 py-3">
        ...
        <Link to="/pharmabro-admin/physician-queue" className="inline-flex items-center gap-1 rounded-lg bg-amber-600 px-3 py-1.5 text-[12.5px] font-semibold text-white hover:bg-amber-700">
  ...
  return (
    <Card className="p-4">
      <SectionHead
        ...
        right={<Link to="/pharmabro-admin/orders" className="text-[11.5px] font-semibold text-indigo-600 hover:underline">View all →</Link>}
      />
      {others.length === 0 && (
      ...
      <ul className="mt-3 space-y-2">
        {others.map((o) => (
          <li key={o.id}>
            <Link to="/pharmabro-admin/orders/$id" params={{ id: o.id }} className="flex items-center justify-between rounded-lg border border-ink/8 bg-white px-3 py-2 hover:border-indigo-300 hover:bg-indigo-50/40">
              <div className="min-w-0">
      ...
      <Link to="/pharmabro-admin/patients/$id" params={{ id: patientId }} className="mt-3 inline-flex items-center gap-1 text-[11.5px] font-semibold text-indigo-600 hover:underline">
