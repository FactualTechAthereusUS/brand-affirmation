...
export const Route = createFileRoute("/pharmabro-admin/pharmacy")({
  ...
  return (
    <AdminShell title="Pharmacy">
      <div className="mb-5 flex flex-wrap items-end justify-between gap-3">
        ...
        <Link to="/pharmabro-admin/settings/pharmacy-routing" className="inline-flex items-center gap-1.5 rounded-lg border border-ink/12 bg-white px-3 py-1.5 text-[12px] font-medium text-ink/80 hover:bg-ink/5">
          Routing rules →
        </Link>
      </div>
              ...
              {orders.slice(0, 14).map((o) => (
                <tr key={o.id} className="border-b border-ink/5 last:border-0 hover:bg-ink/[0.02]">
                  <td className="px-4 py-2.5 font-mono text-[11.5px] text-ink/80">
                    <Link to="/pharmabro-admin/orders/$id" params={{ id: o.id }} className="hover:text-marine hover:underline">{o.id}</Link>
                  </td>
