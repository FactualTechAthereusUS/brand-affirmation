...
export const Route = createFileRoute("/pharmabro-admin/command")({
  ...
  return (
    <AdminShell title="Command center">
      ...
      <Card className="mb-6 p-5">
        <SectionTitle action={<Link to="/pharmabro-admin/orders" className="text-[11px] font-semibold text-ever">Orders →</Link>}>Live pipeline</SectionTitle>
