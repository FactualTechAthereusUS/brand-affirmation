...
export const Route = createFileRoute("/pharmabro-admin/patients/$id")({
  head: ({ params }) => ({ meta: [
...
function PatientDetail() {
  const { id } = useParams({ from: "/pharmabro-admin/patients/$id" });
    ...
    return (
      <AdminShell>
        <div className="grid h-96 place-items-center text-[12.5px] text-ink/45">
          Patient not found.
          <Link to="/pharmabro-admin/patients" className="ml-2 text-indigo-700 underline">Back to patients →</Link>
        </div>
      </AdminShell>
    );
  }
  ...
  return (
    <AdminShell>
      <button onClick={() => nav({ to: "/pharmabro-admin/patients" })} className="mb-4 inline-flex items-center gap-1 text-[12.5px] font-semibold text-ink/60 hover:text-ink">
        ...
        <div className="flex flex-wrap items-start justify-between gap-4">
          ...
          <div className="flex flex-wrap items-center gap-2">
            <button onClick={() => {
              ...
              nav({ to: "/pharmabro-admin/messages" });
      ...
      <StatusBanner p={e}
        ...
        onContact={() => nav({ to: "/pharmabro-admin/messages" })}
      />
      ...
      <div className="grid grid-cols-1 gap-4 lg:grid-cols-3">
        ...
        <div className="space-y-4 lg:col-span-2">
          ...
          {/* Orders */}
          <Card className="p-5">
            <SectionTitle action={<Link to="/pharmabro-admin/orders" className="text-[11.5px] font-semibold text-indigo-700 hover:underline">View all →</Link>}>Orders</SectionTitle>
              ...
              <tbody>
                {orders.slice(0, 3).map((o) => (
                  <tr key={o.id} className="border-t border-ink/[0.06]">
                    ...
                    <td className="text-right"><Link to="/pharmabro-admin/orders/$id" params={{ id: o.id }} className="text-[11.5px] font-semibold text-indigo-700 hover:underline">View</Link></td>
                  </tr>
                ))}
