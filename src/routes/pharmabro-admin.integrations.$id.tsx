...
export const Route = createFileRoute("/pharmabro-admin/integrations/$id")({
  head: ({ params }) => ({ meta: [
...
function IntegrationDetail() {
    ...
    return (
      <AdminShell>
        <div className="rounded-xl border border-dashed border-ink/15 bg-white p-10 text-center">
          ...
          <Link to="/pharmabro-admin/integrations" className="mt-2 inline-block text-[12px] text-marine hover:underline">Back to marketplace</Link>
        </div>
      </AdminShell>
    );
  }
  ...
  return (
    <AdminShell>
      {/* Header */}
      <div className="mb-4">
        <Link to="/pharmabro-admin/integrations" className="mb-3 inline-flex items-center gap-1 text-[11.5px] text-ink/55 hover:text-ink">
