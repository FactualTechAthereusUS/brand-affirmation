      ...
      <div className="mx-auto max-w-7xl px-6 pt-16 pb-8 md:px-10 md:pt-20">
        ...
        <div className="flex flex-col gap-12 md:flex-row md:justify-between md:gap-16">
          <div className="max-w-md">
            <h2 className="font-sans text-[40px] font-medium leading-[1.05] tracking-normal text-white md:text-[64px]">
              Become who you were <br />
              <span className="font-serif font-normal italic">always</span> supposed to be.
            </h2>
