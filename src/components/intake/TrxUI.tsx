...
export function TrxButton({
  ...
  return (
    <motion.button
      ...
      style={{ background: NAVY, boxShadow: "0 12px 30px rgba(29,67,123,0.28)" }}
    >
      {children}
    </motion.button>
  );
  ...
  return (
    <span
      ...
      style={{
        ...
        background: on ? NAVY : "rgba(29,67,123,0.06)",
      }}
      aria-hidden
    >
  ...
  return (
    <motion.button
      ...
      style={{
        ...
        boxShadow: selected
          ? "0 8px 24px rgba(29,67,123,0.12)"
  ...
  return (
    <motion.button
      ...
      style={{
        borderColor: selected ? NAVY : "rgba(23,23,23,0.10)",
        boxShadow: selected
          ? "0 10px 28px rgba(29,67,123,0.14)"
          : "0 1px 0 rgba(0,0,0,0.02)",
      }}
    >
